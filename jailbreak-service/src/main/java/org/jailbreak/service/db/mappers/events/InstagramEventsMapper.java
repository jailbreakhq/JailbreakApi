...
public class InstagramEventsMapper implements ResultSetMapper<Instagram> {
	
	public Instagram map(int index, ResultSet r, StatementContext ctx) throws SQLException {
		int id = r.getInt("id");
		String instagramId = r.getString("instagram_id");
		...
		Instagram.Builder builder = Instagram.newBuilder()
				.setId(id)
